...
class AccountResourceIT {
    ...
    static Stream<ManagedUserVM> invalidUsers() {
        return Stream.of(
            createInvalidUser("Bob", "Green", "invalid", true), // <-- invalid
            createInvalidUser("Bob", "Green", "bob@example.com", true), // password with only 3 digits
            createInvalidUser("Bob", "Green", "bob@example.com", true) // invalid null password
        );
    }
